...
API_KEY = "zBlPgwXPPdZbsLGGWOMHINYw7pZkgnezC4f7c3beKt2Y3oYgfBzXEfvc"  # env
BASE_CSV_DIRECTORY = "csvs"   # env
...
def load_into_db():
    ...
    """
    t = TaskManagement()
    t.get_records(1, 3, 'nature', 80)
    db_file = "test.sqlite3"  # env
